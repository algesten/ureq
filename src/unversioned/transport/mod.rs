...
pub trait Transport: Debug + Send + Sync + 'static {
    ...
    ///
    /// Before performing I/O, use [`NextTimeout::for_write`] to apply the per-write timeout.
    ...
    ///
    /// Before performing I/O, use [`NextTimeout::for_read`] to apply the per-read timeout.
